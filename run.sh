...
git clone --depth=1 https://github.com/Ahmedabduu/odoo-18-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: OdooAhmed.123 | Live chat port: $CHAT"